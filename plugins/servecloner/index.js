  ...
  'cookie': '__sdcfduid=28cf6322cd2a11eda32afa05ee9c977acecdd052fa2ff9243c2ef7fff44b8f23e80421f014c65eedc694ca7fd5df5585; __cfruid=beb024e923d1064b07f8693f0806bb3d8a099186-1679982546; __dcfduid=28cf6322cd2a11eda32afa05ee9c977a'
    ...
    this.onUnload = commands.registerCommand({
      ...
      options: [
          ...
          type: 3,
          required: true,
          displayName: "id do servidor que voce quer clonar",
          displayDescription: "id do servidor que voce quer clonar",
        }, {
          name: "idto",
          description: "idto",
          type: 3,
          required: true,
          displayName: "id do servidor que voce vai colar o clone",
          displayDescription: "id do servidor que voce vai colar o clone",
        }
      ],
      applicationId: -1,
      inputType: 1,
